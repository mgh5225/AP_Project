...
SouthVilla_Details_UI::SouthVilla_Details_UI(sale_file* _s,rent_file* _r,south_villa& sv,QWidget *parent) :sv(sv), QWidget(parent)
{
    ...
    my_v_layout->addWidget(label_yardArea);
    my_v_layout->addWidget(lineEdit_BackYardArea);
    my_v_layout->addWidget(label_ParkingArea);
...
void SouthVilla_Details_UI::AdminMode()
{
    btn_Buy->hide();
    btn_Rent->hide();
    btn_Edit->show();
...
void SouthVilla_Details_UI::UserMode()
{
    btn_Buy->show();
    btn_Rent->show();
    btn_Edit->hide();
...
void SouthVilla_Details_UI::SaleMode()
{
    if(!IsRentMode)
...
void SouthVilla_Details_UI::RentMode()
{
    IsRentMode = true;
...
void SouthVilla_Details_UI::EditClicked()
{
    btn_Buy->hide();
    btn_Rent->hide();
    btn_Edit->hide();
