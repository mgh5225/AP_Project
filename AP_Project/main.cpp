...
int main(int argc, char *argv[])
{
    ...
    apartment* aptr=new apartment(8456,5665,"asdaass","C:/Users/Babak/Desktop/unnamed.jpg",12,23,"afjslfd");
    ...
    flats["0"].push_back(flat(&apartments["0"],12,1,12,50," ",12));
    flats["0"].push_back(flat(&apartments["0"],12,1,12,200," ",1));
    flats["1"].push_back(flat(&apartments["1"],12,1,1,200," ",1));
    */
    user usr;
    manager mgr;
    //User_Panel_UI w(usr);
    //Manager_Panel_UI w(mgr);
